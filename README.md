...
#### 1. [JobTrackerSync](https://github.com/hsummerhays/JobTrackerSync)
...
#### 2. [DailyNotes](https://github.com/hsummerhays/DailyNotes)
> Multi-tenant productivity and knowledge management platform.
...
#### 3. [JavaWithKafka](https://github.com/hsummerhays/JavaWithKafka)
> Event-driven message processing and microservices framework.
...
> Production-ready Node.js API boilerplate showcasing Clean Architecture and Onion/Hexagonal patterns.
...
#### 5. [RabbitMqTest](https://github.com/hsummerhays/RabbitMqTest)
...
#### 6. [CodeDialect](https://github.com/hsummerhays/CodeDialect)
...
*   **Databases & Storage:** PostgreSQL, SQLite, Entity Framework (EF Core)
